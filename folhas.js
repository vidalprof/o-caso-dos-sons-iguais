...
function f0(d){
  ...
  c.innerHTML =
    ...
    '<div class="cena"><i class="foco"></i>' + '<div class="it" style="animation-delay:0.00s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/o5_sal.png?v=' + V + '" alt="">' + '<span class="rt">SAL</span>' + '</div>' + '<div class="it" style="animation-delay:0.35s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/o5_sol.png?v=' + V + '" alt="">' + '<span class="rt">SOL</span>' + '</div>' + '<div class="it" style="animation-delay:0.70s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/o5_anel.png?v=' + V + '" alt="">' + '<span class="rt">ANEL</span>' + '</div>' + '<div class="it" style="animation-delay:1.05s">' + '<img class="capfig" draggable="false" onload="naoAmplia(this)" src="img/o5_anzol.png?v=' + V + '" alt="">' + '<span class="rt">ANZOL</span>' + '</div>' + '</div><div class="prat"></div>' +
...
function f21(d, pi){
  ...
  /* ⚠️ A GRADE É MAIS ALTA DO QUE LARGA, E ISSO É DE PROPÓSITO (21/set/2026).
     ...
     divide por elas, e a linha não custa largura nenhuma. Com 10 colunas a casa
     saía com 30 px no celular pequeno — abaixo do piso de 40 px que o dedo da
     criança precisa, e o portão de leiaute reprovava com razão. Então as colunas
     caem para 7 (casa de 41 px a 320 px, 47 px a 360 px) e as linhas sobem para
     10. AMBIENTE tem OITO letras e por isso entra sempre EM PÉ — a regra vale
     para qualquer palavra maior que o número de colunas. */
  var NC = 7, NL = 10, g = [], y, x, postas = {}, volta;
  /* ⚠️ REDESENHA A GRADE INTEIRA quando alguma palavra não acha lugar. Antes o
     sorteio tinha 400 tentativas POR PALAVRA e, esgotadas, desistia em silêncio:
     a palavra ficava na lista e não existia na grade — beco sem saída que só
     apareceria com a criança na frente. */
